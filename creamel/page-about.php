...
<section id="about_us_in_numbers" >
    <div class="container">
        <div class="row pb-96 pt-96">
            ...
            <?php $i++;endwhile; ?>
            <?php endif; ?>
			<div class="about_us_in_numbers_signature col-12 mb-5"><?php pll_e('signature_about_us_in_numbers'); ?></div>
        </div>
    </div>
</section>
            ...
            <div class="title_our_projects title_section line_left_title col-lg-12 col-12 ps-4 mb-5">
                ...
                <div class="right_about_company_reg  col-lg-6 col-12 d-flex flex-column">
                    ...
                    <div class="bot_about_company_reg d-flex flex-column">
                        ...
                        <div class="location_about_company_reg d-flex flex-column align-items-start mb-5">
                            <div class="location_reg_about d-flex align-items-start mb-2">
                                <img src="/wp-content/uploads/2021/11/icon_geo.svg">
                                <span class="location mx-2"><?php the_field('reg_location'); ?></span>
                            </div>
                            <div class="location_reg_about_thec d-flex align-items-start mb-2">
                                <?php if(get_field('address', $page_id)): ?>
                                    <img src="/wp-content/uploads/2021/11/icon_geo.svg">
                                    <span class="location mx-2"><?php the_field( "address", $page_id ); ?></span>
                                <?php endif; ?>	 
                            </div>
